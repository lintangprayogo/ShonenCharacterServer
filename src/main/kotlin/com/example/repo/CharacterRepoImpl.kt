...
class CharacterRepoImpl : CharacterRepo {
    ...
    override val page4 = listOf(
        ...
        Character(
            ...
            about = "Momoshiki Ōtsutsuki (大筒木モモシキ, Ōtsutsuki Momoshiki) was a member of the Ōtsutsuki clan's main related, sent to investigate the whereabouts of Kaguya and her God Tree and then attempting to cultivate a new one out of the chakra of the Seventh Hokage. In the process of being killed by Boruto Uzumaki, Momoshiki placed a Kāma on him, allowing his spirit to remain intact through the mark.",
            rating = 3.9,
            strength = 98,
            month = "Jan",
            day = "1st",
    ...
    override val characteres: Map<Int, List<Character>> by lazy {
        mapOf(
            1 to page1,
            2 to page2,
            3 to page3,
